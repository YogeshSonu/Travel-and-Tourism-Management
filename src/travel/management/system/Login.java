...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        frgtpswd.setBounds(130,250,130,30);
        frgtpswd.setBackground(new Color(131,193,233));
        frgtpswd.setForeground(Color.WHITE);
        frgtpswd.setBorder(new LineBorder(new Color(131,193,233)));
